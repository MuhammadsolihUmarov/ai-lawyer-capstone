...
_Loom to embed here (≤5 min): the chat surface (markdown answers, gap panel,
streaming) → a grounded cited answer → the admin console (KPIs, feedback,
corpus). Placeholder until the recording is posted._
